...
export const putSchema = z.object({
    ...
    }).min(3, 'El nombre debe tener al menos 3 caracteres').max(15, 'El nombre puede tener como maximo 25 caracteres').regex(/^[A-Za-z ]+$/, 'El nombre debe contener solo letras'),
    apellidos: z.string({
        invalid_type_error: 'El apellido debe ser un string',
        required_error: 'El apellido es requerido',
    }).min(3, 'El apellido debe tener al menos 3 caracteres').max(25, 'El apellido puede tener como maximo 25 caracteres').regex(/^[A-Za-z ]+$/, 'El apellido debe contener solo letras'),
    mail: z.string({
    ...
    }).min(7, 'El numero de telefono debe tener al menos 7 digitos').max(14, 'El numero de telefono puede tener como maximo 14 digitos').regex(/[0-9]/),
});
export const patchSchema = z.object({
    ...
    nombres: z.string({
        invalid_type_error: 'El nombre debe ser un string'
    }).min(3, 'El nombre debe tener al menos 3 caracteres').max(15, 'El nombre puede tener como maximo 25 caracteres').regex(/^[A-Za-z ]+$/, 'El nombre debe contener solo letras').optional(),
    apellidos: z.string({
        invalid_type_error: 'El apellido debe ser un string'
    }).min(3, 'El apellido debe tener al menos 3 caracteres').max(25, 'El apellido puede tener como maximo 25 caracteres').regex(/^[A-Za-z ]+$/, 'El apellido debe contener solo letras').optional(),
    mail: z.string({
        invalid_type_error: 'El mail debe ser un string'
    }).email('El mail debe tener un formato válido').optional(),
    nroTelefono: z.string({
        invalid_type_error: 'El número de teléfono debe ser un string'
    }).min(7, 'El numero de telefono debe tener al menos 7 digitos').max(14, 'El numero de telefono puede tener como maximo 14 digitos').regex(/[0-9]/).optional()
});
